...
function GMSM_score = GMSM(Y1, Y2)
% GMSM - measure the image quality of distorted image 'Y2' with the reference image 'Y1'.
% 
% inputs:
% 
...
% 
% output:
% GMSM_score: distortion degree of the distorted image
