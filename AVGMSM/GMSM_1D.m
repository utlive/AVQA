function GMSM_1D_score = GMSM_1D(audio1,audio2)
...
% 
% output:
% GMSM_1D_score: distortion degree of the distorted audio measured by GMSM_1D

% This is an implementation of the GMSM_1D algorithm described in:
...
GMSM_1D_score = nanmean(quality_map);
