function vifp_1D_score = VIFP_1D(audio1,audio2)
% VIFP_1D - compute the quality of distorted audio 'audio2' with the reference audio 'audio1'.
% 
% inputs:
...
% 
% output:
% vifp_1D_score: distortion degree of the distorted audio measured by VIFP_1D
